...
public class HomingAttack : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (movement == null)
            Debug.LogError("HomingAttack could not find UltimatePlayerMovement in parent objects.");

        if (anim == null)
            Debug.LogError("HomingAttack could not find Animator in child objects.");
    }
